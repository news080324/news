...
urlpatterns = [
    ...
    path('article/article1/', views.article1, name='article1'),
    path('article/article2/', views.article2, name='article2'),
    path('article/article3/', views.article3, name='article3'),
    path('article/article4/', views.article4, name='article4'),
    path('article/article5/', views.article5, name='article5'),
    path('article/article6/', views.article6, name='article6'),
    path('article/article7/', views.article7, name='article7'),
